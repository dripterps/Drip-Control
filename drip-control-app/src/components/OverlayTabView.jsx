  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 dc-fade-in">
      <div className="lg:col-span-2 flex flex-col items-center gap-4">
        ...
        >
          <div style={{ position: "absolute", maxWidth: "calc(100% - 40px)", ...(posStyleMap[overlayPosition] || posStyleMap["bottom-left"]) }}>
            <OverlayWidget bagsLeft={bagsLeft} totalBags={totalBags} variant="full" sizeTier={overlaySize} opacity={overlayOpacity} />
          </div>
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div style={cardStyle}>
          <p className="dc-font-mono" style={eyebrowStyle}>BACKGROUND OPACITY</p>
          <p style={{ fontSize: 12, color: C.textTertiary, marginTop: 6, marginBottom: 12 }}>
            Drag toward 0 for a fully see-through background — just the counter floating over your stream.
          </p>
          <div className="flex items-center gap-3">
            ...
            />
            <span className="dc-font-mono" style={{ fontSize: 12, color: C.textSecondary, width: 38, textAlign: "right" }}>
