...
export default function TrackerView({
  ...
  manualValue, setManualValue, onManualSet, lastUpdated, overlayOpacity,
}) {
      ...
      <div className="flex flex-col gap-3">
        ...
        <div style={{ ...cardStyle, display: "flex", alignItems: "center", justifyContent: "center", minHeight: 220, background: C.inkSoft, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <OverlayWidget bagsLeft={bagsLeft} totalBags={totalBags} variant="mini" opacity={overlayOpacity} />
          </div>
        </div>
